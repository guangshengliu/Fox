...
#define NR_SCAN_CODES 	0x80		//	Total keyboard
#define MAP_COLS	2
...
{
	unsigned char * p_head;			//	Queue head pointer
	unsigned char * p_tail;			//	Queue tail pointer
	int count;
...
#define PAUSEBREAK	1				//	The first type of special keys
#define PRINTSCREEN	2
#define OTHERKEY	4				//	The second type of special keys
#define FLAG_BREAK	0x80

#define PORT_KB_DATA	0x60		//	I/0 port 0x60
#define PORT_KB_STATUS	0x64		//	I/0 port 0x64
#define PORT_KB_CMD	0x64			//	I/0 port 0x64

#define KBSTATUS_IBF	0x02
#define KBSTATUS_OBF	0x01

#define KBCMD_WRITE_CMD	0x60		// 	keyboard configuration commands to write
#define KBCMD_READ_CMD	0x20		//	keyboard configuration commands to read
...
/*
*	Detecting if the input and output buffers are full
*	The detection method is to read the controller status of I/0 port 0X64
*/
