...
/* 
*   Record the linear address of I/0 APIC register and its physical base address
*/

struct IOAPIC_map
{
	unsigned int physical_address;                  //  Register physical address
	unsigned char * virtual_index_address;          //  Index register linear address
	unsigned int *  virtual_data_address;           //  Data register linear address
	unsigned int *  virtual_EOI_address;            //  EOI register linear address
}ioapic_map;
