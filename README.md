...
```
# 从远端复制
git clone git@github.com:guangshengliu/Fox.git
# 仓库初始化
git init
# 添加文件
git add .
...
git commit -m "注释语句"
# 设置源仓库
git remote add origin git@github.com:guangshengliu/Fox.git
# 配置错误时更改源仓库
...
```
dd if=src/boot/boot.bin of=fox.img bs=512 count=1 conv=notrunc
```
...
# 设置回环设备
sudo losetup /dev/loop0 fox.img
